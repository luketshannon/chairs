...
let hash = urlParams.get('hash') ?? undefined
...
function setupParams() {
    ...
    P.background = bools[Bbg] || 1
    P.filled = bools[Bf] && 0
    P.project = bools[Bp] || 1
    P.interactive = bools[Bi] && 0
    P.outlines = false // P.outlines ?? true
...
function setup() {
    ...
    noLoop()
    document.body.style.backgroundColor = P.ink; // Replace with your desired color
